...
beforeEach(async () => {
  ...
  vi.doMock('../../src/locale/zh-TW.js', () => ({
    t: vi.fn((key) => key),
  }));

  mod = await import('../../src/js/model/manager.js');
...
describe('downloadModel', () => {
  ...
  it('returns true on successful download', async () => {
    ...
    const freshMod = await import('../../src/js/model/manager.js');
...
describe('isModelDownloaded', () => {
  ...
  it('returns false when OPFS fails and IndexedDB returns null record', async () => {
    ...
    vi.doMock('../../src/locale/zh-TW.js', () => ({ t: vi.fn((key) => key) }));
    vi.doMock('../../src/js/db.js', () => ({
