...
describe('renderArticle — GPU consent gate', () => {
  ...
  it('shows mobile blocked message on mobile device', async () => {
    ...
    vi.doMock('../../src/lib/pages/analyze-result.js', () => ({ renderResultPreview: vi.fn() }));
    vi.doMock('../../src/lib/pages/analyze-checks.js', () => ({
      runPreAnalysisChecks: mockRunPreAnalysisChecks,
    }));
    vi.doMock('../../src/lib/pages/analyze-engine.js', () => ({ updateStatusUI: vi.fn() }));
    vi.doMock('../../src/lib/pages/article-panels.js', () => ({ loadClusterPanel: vi.fn() }));
    vi.doMock('../../src/lib/core/auto-runner.js', () => ({
      getAutoRunnerStatus: vi.fn(() => ({ running: false })),
    }));
    vi.doMock('../../src/lib/core/benchmark.js', () => ({
    ...
    const mobileMod = await import('../../src/lib/pages/article-detail.js');
    mockFetchArticle.mockResolvedValue({ success: true, data: mockArticle });
