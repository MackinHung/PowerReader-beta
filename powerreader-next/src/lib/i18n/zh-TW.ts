...
const messages: Record<string, string> = {
  ...
  'power_pool.transparency.subtitle': '你的每一次運算都在推動飛輪前進——以下是資源如何被分配與回饋給社群。',
  ...
  'power_pool.transparency.proxy_compute_desc': '由伺服器驅動 AI 模型，為沒有高效能裝置的使用者提供代理算力，讓人人都能參與媒體偏見分析。',
  'power_pool.transparency.other_contrib_title': '其它貢獻',
  'power_pool.transparency.other_contrib_desc': '包含資料庫維護、知識條目編輯等協作行為。回饋機制規劃中，敬請期待。',
  'power_pool.transparency.lottery_title': '公平抽獎回饋',
  'power_pool.transparency.lottery_desc': '每月設有固定獎金池，積極參與運算的貢獻者皆有機會獲得現金回饋。抽獎機制完全去中心化——開發者僅能設定每月配額，無法介入抽獎過程。所有機率與抽獎邏輯皆可透過開源程式碼驗證，確保公平公正、不可操控。',
