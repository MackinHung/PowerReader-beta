...
const messages = {
  ...
  'reward.daily_quota': '每日分析配額',
  'reward.daily_usage': '{used}/{limit} 次',
  'reward.daily_reset': '每日 00:00 (台灣時間) 重置',
  'reward.quota_exhausted': '今日配額已用完，明天再來！',
  ...
  'auto_runner.quota_remaining': '剩餘配額: {remaining} 次',
  'auto_runner.quota_exhausted': '今日配額已用完，自動停止',
